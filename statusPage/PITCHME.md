...
<div class="container">
        ...
        <div class="col-xs-12 col-sm-offset-4 col-sm-8">
            <div class="row">
                <div class="col-xs-4 my_planHeader my_plan1">
                    <div class="my_planTitle">StatusPage.io</div>
                    <div class="my_planPrice">$399</div>
                    <div class="my_planDuration">per month</div>
                </div>
                <div class="col-xs-4 my_planHeader my_plan2">
                    <div class="my_planTitle">Status.io</div>
                    <div class="my_planPrice">$299</div>
                    <div class="my_planDuration">per month</div>
                </div>
                <div class="col-xs-4 my_planHeader my_plan3">
                    <div class="my_planTitle">Cachet</div>
    ...
    <div class="row my_featureRow">
        <div class="col-xs-12 col-sm-4 my_feature">
            Notificação Webhook, SMS, Twitter, Slack, HipChat
        </div>
        <div class="col-xs-12 col-sm-8">
            <div class="row">
                <div class="col-xs-4 col-sm-4 my_planFeature my_plan1">
    ...
    <div class="row my_featureRow">
        <div class="col-xs-12 col-sm-4 my_feature">
            Ter links de components em um incident
        </div>
        <div class="col-xs-12 col-sm-8">
            <div class="row">
                <div class="col-xs-4 col-sm-4 my_planFeature my_plan1">
    ...
    <div class="row my_featureRow">
        <div class="col-xs-12 col-sm-4 my_feature">
            Components display horizontal e vertical
        </div>
        <div class="col-xs-12 col-sm-8">
            <div class="row">
                <div class="col-xs-4 col-sm-4 my_planFeature my_plan1">
    ...
    <div class="row my_featureRow">
        <div class="col-xs-12 col-sm-4 my_feature">
            Independência entre components e incidents
        </div>
        <div class="col-xs-12 col-sm-8">
            <div class="row">
                <div class="col-xs-4 col-sm-4 my_planFeature my_plan1">
